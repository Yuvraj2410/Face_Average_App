...
# Assuming images and points are passed directly as inputs
def average_face(images, allPoints, w=600, h=600):

    # Eye corners
    eyecornerDst = [ (np.int32(0.3 * w ), np.int32(h / 3)), (np.int32(0.7 * w ), np.int32(h / 3)) ]
